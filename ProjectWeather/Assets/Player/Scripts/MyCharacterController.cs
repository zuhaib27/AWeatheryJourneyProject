...
namespace Assets.Player.Scripts
{
    ...
    public class MyCharacterController : MonoBehaviour, ICharacterController
    {
        ...
        [Header("Impulse/Wind Ability")] public bool AllowCharacterImpulse = true;
        ...
        {
            // Handle animation
            _forwardAxis = Mathf.Lerp(_forwardAxis, _targetForwardAxis,
                1f - Mathf.Exp(-ForwardAxisSharpness * Time.deltaTime));
